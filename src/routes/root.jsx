...
export default function Root() {
    return (
        <div className='flex flex-col gap-8'>
            ...
            <Link to={`app`} className='border w-fit py-2 px-4 rounded-md flex items-center text-lg bg-customblue text-customblack duration-100 hover:bg-customblack hover:bg-customblue hover:text-customblue'>
                    go to app
            </Link>
        </div>
    )
